...
func registerSDKWords(r *eng.Registry, client *sdk.FreetestapiSDK) {
...
func runOp(client *sdk.FreetestapiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
