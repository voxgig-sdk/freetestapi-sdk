// Command Freetestapi-cli is a CLI + REPL for the Freetestapi SDK,
...
const prompt = "freetestapi"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "product user"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      FREETESTAPI_APIKEY (api key), FREETESTAPI_BASE (base url override)")
