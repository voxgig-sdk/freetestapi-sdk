...
|---|---|---|
| `ts/` | @voxgig-sdk/freetestapi-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/freetestapi-sdk \
      --repository voxgig-sdk/freetestapi-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/freetestapi-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/freetestapi-sdk --id=<id>` removes one.
