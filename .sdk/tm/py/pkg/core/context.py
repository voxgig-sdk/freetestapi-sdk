...
from projectname_sdk.core.control import FreetestapiControl
...
class FreetestapiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FreetestapiSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreetestapiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreetestapiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreetestapiError(code, msg, self)
