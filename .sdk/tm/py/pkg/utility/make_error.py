# Freetestapi SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, FreetestapiError):
        errmsg = err.msg
    ...
    msg = "FreetestapiSDK: " + opname + ": " + errmsg
    ...
    sdk_err = FreetestapiError("", msg, ctx)
