...
from projectname_sdk import FreetestapiSDK
from projectname_sdk.core.spec import FreetestapiSpec
from projectname_sdk.core.result import FreetestapiResult
from projectname_sdk.core.response import FreetestapiResponse
from projectname_sdk.core.operation import FreetestapiOperation
from projectname_sdk.core.error import FreetestapiError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FreetestapiBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return FreetestapiError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FreetestapiSDK.test(None, None)
        ...
        class TestInitFeature(FreetestapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FreetestapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FreetestapiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FreetestapiSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = FreetestapiOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FreetestapiSDK.test(None, setup_opts)
