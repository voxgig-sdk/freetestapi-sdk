...
class FreetestapiRbacFeature extends FreetestapiBaseFeature
{
    ...
    private function _required(FreetestapiContext $ctx): ?string
    {
    ...
    private function _reject(FreetestapiContext $ctx, string $required): void
    {
    ...
    private function _track(FreetestapiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
