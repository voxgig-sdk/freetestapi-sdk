...
class FreetestapiProxyFeature extends FreetestapiBaseFeature
{
    ...
    public function init(FreetestapiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreetestapiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
