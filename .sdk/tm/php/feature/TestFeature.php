...
// Freetestapi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FreetestapiTestFeature extends FreetestapiBaseFeature
{
    ...
    public function init(FreetestapiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FreetestapiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FreetestapiParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FreetestapiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FreetestapiContext $ctx, $op, $args): array
    {
