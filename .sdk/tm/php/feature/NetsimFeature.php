...
// Freetestapi SDK netsim feature
...
class FreetestapiNetsimFeature extends FreetestapiBaseFeature
{
    ...
    private function _simulate(FreetestapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FreetestapiContext $ctx, array $applied): void
    {
        $client = $this->client;
