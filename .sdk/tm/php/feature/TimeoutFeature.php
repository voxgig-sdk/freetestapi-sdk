...
// Freetestapi SDK timeout feature
...
class FreetestapiTimeoutFeature extends FreetestapiBaseFeature
{
    ...
    private function _with_timeout(FreetestapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreetestapiContext $_ctx, float $ms): void
    {
        $client = $this->client;
