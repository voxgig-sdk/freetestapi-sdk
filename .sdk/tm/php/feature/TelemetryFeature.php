...
// Freetestapi SDK telemetry feature
...
class FreetestapiTelemetryFeature extends FreetestapiBaseFeature
{
    ...
    private function _close(FreetestapiContext $ctx, bool $ok): void
    {
