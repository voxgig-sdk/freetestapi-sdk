...
class FreetestapiCacheFeature extends FreetestapiBaseFeature
{
    ...
    private function _through(FreetestapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
