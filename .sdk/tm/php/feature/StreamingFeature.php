...
// Freetestapi SDK streaming feature
...
class FreetestapiStreamingFeature extends FreetestapiBaseFeature
{
    ...
    private function _iterate(FreetestapiResult $result): \Generator
    {
    ...
    private function _streamable(FreetestapiContext $ctx): bool
    {
