...
// Freetestapi SDK metrics feature
...
class FreetestapiMetricsFeature extends FreetestapiBaseFeature
{
    ...
    private function _record(FreetestapiContext $ctx, bool $ok): void
    {
