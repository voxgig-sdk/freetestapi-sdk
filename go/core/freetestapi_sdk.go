...
func (sdk *FreetestapiSDK) OptionsMap() map[string]any {
...
func (sdk *FreetestapiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FreetestapiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FreetestapiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreetestapiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FreetestapiSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FreetestapiSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FreetestapiSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FreetestapiSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreetestapiSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FreetestapiSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
