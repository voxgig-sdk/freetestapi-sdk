...
// instead of `sdk.NewFreetestapiSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *FreetestapiSDK  { return NewFreetestapiSDK(nil) }
func Test() *FreetestapiSDK { return TestSDK(nil, nil) }
