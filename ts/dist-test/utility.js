...
function envOverride(m) {
    if ('TRUE' === process.env.FREETESTAPI_TEST_LIVE ||
        'TRUE' === process.env.FREETESTAPI_TEST_OVERRIDE) {
    ...
    m.FREETESTAPI_TEST_EXPLAIN = process.env.FREETESTAPI_TEST_EXPLAIN || m.FREETESTAPI_TEST_EXPLAIN;
    return m;
}
