...
(0, node_test_1.describe)('UserDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FreetestapiSDK({
...
function liveScenariosActive() { return false && process.env.FREETESTAPI_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FreetestapiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FREETESTAPI_TEST_USER_ENTID'];
    ...
    const client = new __1.FreetestapiSDK({
        base: 'http://localhost:8080',
