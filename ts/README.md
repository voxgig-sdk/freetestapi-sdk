# Freetestapi TypeScript SDK



The TypeScript SDK for the Freetestapi API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/freetestapi-sdk/releases](https://github.com/voxgig-sdk/freetestapi-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `FreetestapiSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `FreetestapiSDK.test(testopts?, sdkopts?)` | `FreetestapiSDK` | Create a test-mode client. |
...
| `client` | `client(): FreetestapiSDK` | Return the parent SDK client. |
...
freetestapi/
├── src/
│   ├── FreetestapiSDK.ts        # Main SDK class
