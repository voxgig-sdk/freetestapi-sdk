...
#      offline in seeded test mode (FreetestapiSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Freetestapi_sdk.rb")
  SDK_CLASS = "FreetestapiSDK"
