...
module FreetestapiTestRunner
  ...
  def self.env_override(m)
    live = getenv("FREETESTAPI_TEST_LIVE")
    override = getenv("FREETESTAPI_TEST_OVERRIDE")
    ...
    explain = getenv("FREETESTAPI_TEST_EXPLAIN")
    m["FREETESTAPI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = FreetestapiTestRunner
Helpers = FreetestapiHelpers
Vs = VoxgigStruct
