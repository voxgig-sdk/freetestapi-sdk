// Command Freetestapi-mcp is an MCP server exposing the Freetestapi
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Freetestapi_list  — list records of an entity
//	Freetestapi_load  — load a single record of an entity
//
