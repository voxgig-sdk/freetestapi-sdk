...
FreeTestAPI provides over 25 dummy APIs to streamline the process of API testing for developers.

Learn more about FreeTestAPI at [freetestapi.com](https://freetestapi.com).
...
This SDK exposes the API as a small set of **semantic entities** — Product and User — that you
...
| Python | `voxgig-sdk-freetestapi-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/freetestapi-sdk/tags) |
| PHP | `voxgig-sdk/freetestapi-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/freetestapi-sdk/tags) |
| Golang | `github.com/voxgig-sdk/freetestapi-sdk/go` | `go get github.com/voxgig-sdk/freetestapi-sdk/go@latest` |
| Ruby | `voxgig-sdk-freetestapi-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/freetestapi-sdk/tags) |
| Lua | `voxgig-sdk-freetestapi-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/freetestapi-sdk/tags) |
