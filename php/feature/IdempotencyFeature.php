...
// Freetestapi SDK idempotency feature
...
class FreetestapiIdempotencyFeature extends FreetestapiBaseFeature
{
    ...
    private function _mutating(FreetestapiContext $ctx): bool
    {
