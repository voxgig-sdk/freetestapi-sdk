...
// Freetestapi SDK ratelimit feature
...
class FreetestapiRatelimitFeature extends FreetestapiBaseFeature
{
    ...
    private function _acquire(FreetestapiContext $ctx): void
    {
    ...
    private function _track(FreetestapiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
