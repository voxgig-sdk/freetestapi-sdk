...
// Freetestapi SDK clienttrack feature
...
class FreetestapiClienttrackFeature extends FreetestapiBaseFeature
{
    ...
    public function PostConstruct(FreetestapiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Freetestapi-SDK';
