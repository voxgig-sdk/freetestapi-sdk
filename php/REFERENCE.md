# Freetestapi PHP SDK Reference

Complete API reference for the Freetestapi PHP SDK.
...
#### `FreetestapiSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): FreetestapiUtility`
