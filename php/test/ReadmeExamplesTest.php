...
// Freetestapi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreetestapiSDK::test)
...
{
    private const SDK_CLASS = 'FreetestapiSDK';
    ...
    private const SDK_BASE = 'freetestapi_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../freetestapi_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
