...
class FreetestapiTestRunner
{
    ...
    {
        $live = self::getenv('FREETESTAPI_TEST_LIVE');
        $override = self::getenv('FREETESTAPI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FREETESTAPI_TEST_EXPLAIN');
...
class_alias('FreetestapiTestRunner', 'Runner');
class_alias('FreetestapiHelpers', 'Helpers');
