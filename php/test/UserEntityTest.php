...
class UserEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FREETESTAPI_TEST_USER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function user_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FREETESTAPI_TEST_USER_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["FREETESTAPI_TEST_USER_ENTID"]);
