...
{
    private static function utility(): FreetestapiUtility
    {
        return new FreetestapiUtility();
    }
    ...
    private static function ctx(array $over = []): FreetestapiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FreetestapiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FreetestapiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FreetestapiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FreetestapiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FreetestapiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FreetestapiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FreetestapiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FreetestapiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FreetestapiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreetestapiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FreetestapiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FreetestapiResponse([]),
            'result' => new FreetestapiResult([]),
        ]);
        [, $err] = FreetestapiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FreetestapiSpec([]),
            'response' => null,
            'result' => new FreetestapiResult([]),
        ]);
        [, $err] = FreetestapiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FreetestapiSpec(['step' => 's']),
            'response' => new FreetestapiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FreetestapiResult([]),
        ]);
        [, $err] = FreetestapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FreetestapiSpec(['step' => 's']),
            'response' => new FreetestapiResponse(self::resp(200, ['v' => 1])),
            'result' => new FreetestapiResult([]),
        ]);
        [, $err] = FreetestapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FreetestapiSpec(['step' => 's']),
            'response' => new FreetestapiResponse(self::resp(200, ['v' => 2])),
            'result' => new FreetestapiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FreetestapiMakeResponse::call($ctx);
    ...
    {
        $preset = new FreetestapiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FreetestapiSpec([]),
            'response' => new FreetestapiResponse([]),
            'result' => new FreetestapiResult([]),
        ...
        [$got, $err] = FreetestapiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FreetestapiResult([])]);
        [, $err] = FreetestapiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FreetestapiSpec([]), 'result' => null]);
        [, $err] = FreetestapiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreetestapiSpec(['step' => 's']),
            'result' => new FreetestapiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FreetestapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreetestapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreetestapiSpec(['step' => 's']),
            'result' => new FreetestapiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FreetestapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreetestapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreetestapiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FreetestapiSpec([]),
            'result' => new FreetestapiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FreetestapiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreetestapiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FreetestapiError('boom', 'boom');
        $utility->fetcher = function (FreetestapiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreetestapiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FreetestapiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FreetestapiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FreetestapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FreetestapiResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FreetestapiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FreetestapiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreetestapiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FreetestapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FreetestapiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FreetestapiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FreetestapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FreetestapiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FreetestapiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FreetestapiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FreetestapiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FreetestapiResult(['ok' => false])]);
        $this->expectException(FreetestapiError::class);
        FreetestapiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FreetestapiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FreetestapiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FreetestapiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FreetestapiBaseFeature();
        $b = new FreetestapiBaseFeature();
        FreetestapiFeatureAdd::call($ctx, $a);
        FreetestapiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FreetestapiBaseFeature
    {
        $f = new FreetestapiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FreetestapiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?FreetestapiSpec $spec): FreetestapiContext
    {
    ...
    private static function auth_bags(): FreetestapiSpec
    {
        return new FreetestapiSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        FreetestapiPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreetestapiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FreetestapiResponse(['headers' => null]),
            'result' => new FreetestapiResult([]),
        ]);
        FreetestapiResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FreetestapiResultBody::call($ctx);
