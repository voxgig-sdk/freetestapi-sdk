...
// Freetestapi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FreetestapiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FreetestapiOmni::structfix($now, Struct::undef()))
                        !== json_encode(FreetestapiOmni::structfix($val, Struct::undef()))) {
