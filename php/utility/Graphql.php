...
// Freetestapi SDK utility: graphql
//
...
class FreetestapiGraphql
{
    ...
    // equivalent.
    public static function body(FreetestapiContext $ctx): mixed
    {
    ...
    public static function errors(FreetestapiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
