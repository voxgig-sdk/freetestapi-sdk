...
class FreetestapiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreetestapiSDK/1.0)';
    ...
    public static function call(FreetestapiContext $ctx, string $fullurl, array $fetchdef): array
    {
