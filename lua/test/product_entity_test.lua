...
describe("ProductEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FREETESTAPI_TEST_PRODUCT_ENTID JSON to run live")
      return
    end
...
function product_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FREETESTAPI_TEST_PRODUCT_ENTID")
  ...
  if env["FREETESTAPI_TEST_LIVE"] == "TRUE" then
