...
function runner.env_override(m)
  local live = runner.getenv("FREETESTAPI_TEST_LIVE")
  local override = runner.getenv("FREETESTAPI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREETESTAPI_TEST_EXPLAIN")
