# Freetestapi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreetestapiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreetestapiSDK(...) and FreetestapiSDK.test(...) become
#      FreetestapiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freetestapi_sdk"
_SDK_CLASS = "FreetestapiSDK"
