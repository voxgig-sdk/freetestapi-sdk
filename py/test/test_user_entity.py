...
class TestUserEntity:
    ...
    def test_should_stream(self):
        ...
        base = FreetestapiSDK.test(seed, None)
    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set FREETESTAPI_TEST_USER_ENTID JSON to run live")
        client = setup["client"]
...
def _user_basic_setup(extra):
    ...
    client = FreetestapiSDK.test(options, extra)
    ...
    idmap_resolved = helpers.to_map(
        env.get("FREETESTAPI_TEST_USER_ENTID"))
    ...
    if env.get("FREETESTAPI_TEST_LIVE") == "TRUE":
        ...
        client = FreetestapiSDK(helpers.to_map(merged_opts))

    _live = env.get("FREETESTAPI_TEST_LIVE") == "TRUE"
    return {
        "client": client,
        "data": entity_data,
        "idmap": idmap_resolved,
        "env": env,
        "explain": env.get("FREETESTAPI_TEST_EXPLAIN") == "TRUE",
        "live": _live,
