...
from freetestapi_sdk.utility import register

# Load features
from freetestapi_sdk.feature.base_feature import FreetestapiBaseFeature
from freetestapi_sdk.features import _has_feature, _make_feature
...
class FreetestapiSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FreetestapiUtility()
        self._utility = utility

        from freetestapi_sdk.config import shared_config
    ...
    def get_utility(self):
        return FreetestapiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreetestapiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Product(self, data=None) -> "ProductEntity":
        ...
        from freetestapi_sdk.entity.product_entity import ProductEntity
        return ProductEntity(self, data)


    def User(self, data=None) -> "UserEntity":
        """Entity factory: client.User().list() / client.User().load({"id": ...})."""
        from freetestapi_sdk.entity.user_entity import UserEntity
        return UserEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "FreetestapiSDK":
        if sdkopts is None:
            sdkopts = {}
